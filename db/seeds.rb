...
@night_4_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-24'), cost: 70.0)
@night_5_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-25'), cost: 70.0)
@night_6_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-26'), cost: 70.0)
@night_7_trip_5 = @trip_5.nights.create!(date: Date.parse('2024-04-27'), cost: 70.0)
@meal_1_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-22'), time_of_day: 0, cost: 5.0)
@meal_2_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-22'), time_of_day: 1, cost: 5.0)
@meal_3_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-23'), time_of_day: 0, cost: 5.0)
@meal_4_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-23'), time_of_day: 1, cost: 5.0)
@meal_5_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-24'), time_of_day: 0, cost: 5.0)
@meal_6_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-24'), time_of_day: 1, cost: 5.0)
@meal_7_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-25'), time_of_day: 0, cost: 5.0)
@meal_8_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-25'), time_of_day: 1, cost: 5.0)
@meal_9_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-26'), time_of_day: 0, cost: 5.0)
@meal_10_trip_5 = @trip_5.meals.create!(date: Date.parse('2024-04-26'), time_of_day: 1, cost: 5.0)
