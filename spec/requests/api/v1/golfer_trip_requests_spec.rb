  ...
  describe 'GET /golfers/:golfer_id/golfer_trips/:trip_id requets' do
    describe 'happy path' do
      it 'returns some golfers trip data for a specific trip' do
        ...
        expect(trip[:attributes].keys).to eq([:nights, :courses, :meals])
        ...
        expect(trip[:attributes][:nights][0][:date]).to eq(@night_1_trip_4.date)
        expect(trip[:attributes][:nights][1][:date]).to eq(@night_2_trip_4.date)
        expect(trip[:attributes][:nights][2][:date]).to eq(@night_3_trip_4.date)
        expect(trip[:attributes][:nights][3][:date]).to eq(@night_4_trip_4.date)
        expect(trip[:attributes][:nights][4][:date]).to eq(@night_5_trip_4.date)
        expect(trip[:attributes][:nights][5][:date]).to eq(@night_6_trip_4.date)
        expect(trip[:attributes][:nights][6][:date]).to eq(@night_7_trip_4.date)
        ...
        expect(trip[:attributes][:meals][0][:date]).to eq(@meal_1_trip_4.date)
        expect(trip[:attributes][:meals][1][:date]).to eq(@meal_2_trip_4.date)
        expect(trip[:attributes][:meals][2][:date]).to eq(@meal_3_trip_4.date)
        expect(trip[:attributes][:meals][3][:date]).to eq(@meal_4_trip_4.date)
        expect(trip[:attributes][:meals][4][:date]).to eq(@meal_5_trip_4.date)
        expect(trip[:attributes][:meals][5][:date]).to eq(@meal_6_trip_4.date)
        expect(trip[:attributes][:meals][6][:date]).to eq(@meal_7_trip_4.date)
        expect(trip[:attributes][:meals][7][:date]).to eq(@meal_8_trip_4.date)
        expect(trip[:attributes][:meals][8][:date]).to eq(@meal_9_trip_4.date)
        expect(trip[:attributes][:meals][9][:date]).to eq(@meal_10_trip_4.date)
        expect(trip[:attributes][:meals][10][:date]).to eq(@meal_11_trip_4.date)
        expect(trip[:attributes][:meals][11][:date]).to eq(@meal_12_trip_4.date)
        expect(trip[:attributes][:meals][12][:date]).to eq(@meal_13_trip_4.date)
      end
    end
  end
  ...
  describe 'GET /golfers/:golfer_id/golfer_trips request' do
    describe 'happy path' do
      it 'returns all of some golfers trips, along with each trips nights,
        ...
        expect(trips[0][:attributes].keys).to eq([:nights, :courses, :meals])
